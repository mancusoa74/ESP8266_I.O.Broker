...
$config['smtp_email'] = 'your-email';
$config['smtp_username'] = '111@bk.ru';  //Смените на имя своего почтового ящика.
...
smtpmail('111@bk.ru', 'Показания датчиков SmartHoume', $text_email, 'mail'); //используем майл - первая строка - адресат
?>
