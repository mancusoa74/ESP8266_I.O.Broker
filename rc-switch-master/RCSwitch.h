...
#define RCSWITCH_MAX_CHANGES 67//67

#define PROTOCOL3_SYNC_FACTOR   71 //71 //75!
#define PROTOCOL3_0_HIGH_CYCLES  4 //4
#define PROTOCOL3_0_LOW_CYCLES  11 //11
#define PROTOCOL3_1_HIGH_CYCLES  9 //9
#define PROTOCOL3_1_LOW_CYCLES   6 //6
