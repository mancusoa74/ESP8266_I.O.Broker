...
/**************************************************************************************************
 * ConnecToTelegram - function to achieve connection to api.telegram.org and send command to telegram *
...
void TelegramBOT::getUpdates(String offset)  {
    ...
    if (mess!="") {
            ...
            message[i][0]=a.substring(0, ch_count);   //Assign of parsed message into message matrix
    }
